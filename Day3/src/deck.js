const slideDefinitions = [
  ...
  },
  {
    ...
    details: [
      { label: "Document", text: "Lưu dữ liệu dạng document JSON, linh hoạt, ví dụ MongoDB và CouchDB." },
      { label: "Key-Value", text: "Lưu cặp khóa giá trị, tra cứu cực nhanh khi biết khóa, ví dụ Redis và DynamoDB." },
      { label: "Column-family", text: "Tổ chức theo cột, tối ưu ghi đọc khối lượng lớn, ví dụ Cassandra và HBase." },
      { label: "Graph", text: "Lưu dạng nút và cạnh, tối ưu duyệt quan hệ, ví dụ Neo4j cho mạng xã hội và gợi ý." },
    ],
    layout: "flow",
    tone: "violet",
  },
  {
    ...
    details: [
      { label: "Vector", text: "Lưu vector embedding và tìm theo độ tương đồng ngữ nghĩa, là xương sống của RAG, ví dụ Pinecone, Milvus, Qdrant." },
      { label: "Time-series", text: "Tối ưu cho dữ liệu gắn mốc thời gian như IoT và giám sát, ví dụ InfluxDB, TimescaleDB, Prometheus." },
      { label: "In-memory", text: "Lưu dữ liệu trong RAM nên truy cập gần như tức thời, dùng cho cache và session, ví dụ Redis, Memcached." },
      { label: "Search", text: "Dùng inverted index cho tìm kiếm toàn văn và phân tích log, ví dụ Elasticsearch và Solr." },
    ],
    layout: "concept",
    tone: "teal",
  },
  {
    section: "Comparison",
    kicker: "Hai loại workload",
    title: "OLTP và OLAP",
    body:
      "OLTP xử lý nhiều giao dịch nhỏ thời gian thực, OLAP phân tích khối lượng dữ liệu lớn để ra quyết định, dữ liệu thường chảy từ OLTP qua ETL sang OLAP.",
    keyMessage:
      "OLTP dùng CSDL quan hệ theo hàng cho giao dịch, OLAP dùng data warehouse theo cột cho phân tích.",
    points: ["Giao dịch", "Phân tích", "Theo hàng", "Theo cột"],
    details: [
      { label: "OLTP", text: "Xử lý giao dịch nhỏ thời gian thực như tạo đơn, dùng MySQL, PostgreSQL, Oracle hoặc SQL Server." },
      { label: "OLAP", text: "Phân tích dữ liệu lớn để báo cáo và tìm xu hướng, dùng warehouse như Snowflake, BigQuery, Redshift." },
      { label: "So sánh", text: "OLTP giống quầy thu ngân xử lý từng giao dịch nhanh, OLAP giống phòng phân tích tổng hợp dữ liệu nhiều năm." },
      { label: "Phối hợp", text: "Dữ liệu chảy từ OLTP qua ETL hoặc CDC vào OLAP, kiến trúc hiện nay thường chạy cả hai song song." },
    ],
    layout: "comparison",
    tone: "orange",
  },
  ...
  },
  {
    ...
    details: [
      { label: "Workload", text: "Quan trọng nhất, xác định OLTP hay OLAP, đọc nhiều hay ghi nhiều." },
