    ...
    details: [
      {
        ...
        example: "Chrome chạy ở một nhà, Word ở nhà khác, nên Chrome sập thì Word vẫn chạy bình thường.",
      },
      {
        label: "Thread",
        text: "Một người nấu trong nhà; nhiều người chung một nhà thì dùng chung bếp và kho.",
        example: "Hai người trong cùng một nhà cùng mở một tủ lạnh thì lấy đồ nhanh nhưng dễ va nhau.",
      },
      {
        label: "Concurrency",
    ...
    details: [
      {
        ...
        example: "Bạn gọi thêm 10 người vào nhà bằng ThreadPoolExecutor(max_workers=10).",
      },
      {
        label: "Khi nào dùng",
        text: "I/O-bound: gọi API, đọc ghi file, query database, download.",
        example: "Chẳng hạn khi bạn gọi 100 API hoặc đọc 20 file CSV cùng một lúc.",
      },
      {
    ...
    details: [
      {
        ...
        example: "Bạn nên thuê số nhà (max_workers) bằng đúng số nhân CPU của máy.",
      },
      {
        label: "Khi nào dùng",
        text: "CPU-bound: xử lý ảnh, tính toán nặng, ML, transform dữ liệu.",
        example: "Chẳng hạn khi bạn resize 10.000 tấm ảnh hoặc encode một video dài.",
      },
      {
        label: "Chi phí",
      ...
      },
      {
        ...
        example: "Thiếu dòng guard này, mỗi nhà con lại đi thuê thêm nhà, cứ thế lặp vô tận.",
      },
    ],
    callout: {
      type: "warning",
...
asyncio.run(main())`,
    ...
    details: [
      ...
      },
      {
        ...
        example: "Bạn viết results = await asyncio.gather(*tasks) để chạy nhiều việc cùng lúc.",
      },
      {
        label: "Khi nào dùng",
      ...
      },
      {
        ...
        example: "Một lời gọi requests.get() bắt người nấu đứng chờ, nên phải thay bằng aiohttp.",
      },
    ],
    callout: {
      type: "tip",
  ...
  },
  {
    ...
    examples: [
      "Tải 50 file PDF từ mạng về thì chọn Multithreading.",
      "Resize 10.000 tấm ảnh thì chọn Multiprocessing.",
      "Thu thập 10.000 trang web thì chọn Asyncio.",
      "Huấn luyện một mô hình ML thì chọn Multiprocessing.",
